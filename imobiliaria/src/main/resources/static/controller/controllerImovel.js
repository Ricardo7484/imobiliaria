...
moduloImovel.controller("cadImovelController", function ($scope, $http) {
    ...
    $scope.gravarImovel = function () {
        $http.post('http://localhost:8080/inseriImovel/', {
            ...
            "dataAlteracao": $scope.imovel.dataAlteracao, 
    ...
    $scope.encodeImageFileAsURL = function (){
        ...
        if (filesSelected.length > 0) {
            ...
            fileReader.onload = function(fileLoadedEvent) {
                ...
                //alert(i);
                //document.querySelectorAll('[id="image"]')[0].src = srcData.substr(23); //'data:image01/jpeg;base64,'
                //console.log(srcData.substr(23));
                //if(i == 1){
                //$scope.foto01 = srcData.substr(23);
                //document.querySelectorAll('[id="foto01"]')[0].value = srcData.substr(23);
                //document.getElementById("foto01").innerHTML = srcData.substr(23);
                //alert(srcData.substr(23));
                document.getElementById("urlFoto").innerText = srcData.substr(23);
                //window.alert(srcData.substr(23))
                //}
                //console.log(srcData);
            }
    ...
    //dataFormatada = dataHoje.toLocaleDateString("pt-BR").replaceAll('/', '-');
    //document.getElementById("dataCadastro").setAttribute("value", dataFormatada);
...
/*$scope.encodeImageFileAsURL = function (){
    ...
    fileReader.onload = function(fileLoadedEvent) {
        ...
        document.querySelectorAll('[id="foto01"]')[0].src = srcData; //'data:image01/jpeg;base64,'
